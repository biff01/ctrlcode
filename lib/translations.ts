...
export const translations: Record<'ru' | 'uz', Record<string, string>> = {
  ru: {
    ...
    '/ hour': '/ час',
    'Design-to-code from your wireframe': 'Разработка по вашему вайрфрейму',
    'Fully remote delivery': 'Полностью удалённая работа',
    'Fast turnaround, Mon–Fri': 'Быстрые сроки, пн–пт',
  ...
  uz: {
    ...
    'Enterprise': 'Enterprise',
    '/ hour': '/ soat',
    'Design-to-code from your wireframe': 'Vayrfreymingizdan kodga',
    'Fully remote delivery': "To'liq masofadan bajarish",
    'Fast turnaround, Mon–Fri': 'Tez bajarish, dush–juma',
