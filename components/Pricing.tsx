        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
          ...
          <div
            style={{
              display: 'flex',
              alignItems: 'center',
              background: dark ? 'var(--surface-3)' : '#EEF0F8',
              borderRadius: 99,
              padding: '4px',
              gap: 2,
            }}
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    fontSize: 13,
                    background: active
                      ? dark ? 'var(--tab-active)' : '#0D1B4B'
                      : 'transparent',
                    color: active
                      ? dark ? 'var(--text-primary)' : '#FFFFFF'
                      : dark ? 'var(--text-tertiary)' : '#777777',
            ...
            return (
              <motion.div
                ...
                style={{
                  ...
                  gap: 0,
                  borderRadius: 20,
                  background: dark ? 'var(--surface-2)' : '#FFFFFF',
                  padding: 16,
                  overflow: 'hidden',
                  position: 'relative',
                  border: showAmber ? '1px solid rgba(200,140,30,0.35)' : '1px solid transparent',
                  boxShadow: showAmber
                    ? '0 0 0 1px rgba(200,140,30,0.15), 0 20px 80px rgba(140,80,0,0.35), 0 4px 20px rgba(0,0,0,0.3)'
                    : dark
                    ? 'none'
                    : '0px 2px 8px rgba(13,27,75,0.04), 0px 16px 40px rgba(13,27,75,0.06)',
                }}
              >
                {/* Amber shimmer top line — dark mode premium only */}
                {showAmber && (
                  <div style={{
                    position: 'absolute',
                ...
                >
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 6, position: 'relative' }}>
                    ...
                    <p className="font-body" style={{ fontSize: 12.5, color: 'rgba(255,255,255,0.45)', lineHeight: 1.5 }}>
                      {t(plan.subtitle)}
                    </p>
                  </div>
